...
# Description
This is a branch as a part of one of the state management presentation linked below. In this branch, you will find the code that has basic Redux added to it. You can use this branch to see how Redux was implemented.
